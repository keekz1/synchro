...
export default function Navbar() {
  ...
  } backdrop-blur-sm text-black p-1 fixed top-0 left-0 right-0 z-40 shadow-lg max-h-[20px]`} // Reduced height and padding behind navbar
>
...
{isSettingsPage && (
  <motion.nav
    ...
    className="fixed top-0 left-0 right-0 z-50 bg-secondary backdrop-blur-sm p-2 shadow-lg"
  >
